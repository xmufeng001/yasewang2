...
var multiple = new nconf.Provider({
  stores: [
    { name: 'user', type: 'file', file: path.join(__dirname, 'user-game1-CBT_common_account.json') },
    { name: 'global', type: 'global', file: path.join(__dirname, 'global-game1-CBT_common_account.json') }
  ]
});
